...
const mcp = new Server(
  { name: 'phone-channel', version: '0.1.0' },
  {
    ...
    instructions: [
      ...
      '',
      'For tasks: spawn on desktop via desktop-channel HTTP POST:',
      '  curl -s -d \'{"task_id":"p-001","type":"exec","body":"python /home/thatcher/projects/softwaresoftware/projects/plugins/providers/taskpilot/spawner_cli.py \'<description>\'"}\'  http://100.99.44.89:8789',
